...
The system is open-source at \url{https://github.com/AgenOS/agentic-memory-mcp}.
...
O.~Owolabi. ``AgenticMemory: Persistent Cognitive Graph Memory for LLM Agents.'' AgenOS Project, 2025.
